...
class Seo_Admin_GeneratorModel extends Seo_GeneratorModel
{
    ...
    public function getItemLanguageKeywords($entity_id_name = null)
    {
        ...
        if (!empty($data['search_string'])) {
            ...
            (
                ...
                main_table.' . $table['primary_key'] . ' IN (
                  ...
                  FROM ' . DB_PREFIX . (empty($data['language_id']) || $data['language_id'] == $data['original_language_id'] ? '' : 'tb_') . 'url_alias
