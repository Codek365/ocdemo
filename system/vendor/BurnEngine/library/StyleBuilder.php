...
class TB_StyleBuilder
{
    ...
    public function getFontsString()
    {
        ...
        foreach ($this->getFonts() as $font) {
            ...
            if (!empty($font['has_line_height']) && (!empty($font['line-height']) || (!empty($font['size']) && (empty($font['inherit_mask']) || !($font['inherit_mask'] & 1)))))  {
                if (!isset($font['inherit_mask']) || !strlen($font['inherit_mask']) || $font['inherit_mask'] & 2) {
