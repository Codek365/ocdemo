...
abstract class TB_Widget extends TB_WidgetBase
{
    ...
    public function onEditSystem(array &$settings)
    {
        foreach (array('box', 'title') as $style_section_id) {
            if (isset($settings[$style_section_id . '_styles']['colors'])) {
                TB_ColorSchemer::getInstance()->filterWidgetColors($settings[$style_section_id . '_styles']['colors'], $this->getDefaultColors($style_section_id));
            }
    ...
    protected function renderContent($content)
    {
        ...
        $content = '<div id="' . $this->getDomId() . '" class="' . $this->getBoxClasses() . '">' . $content . '</div>';
