  ...
  <div id="menu_url_form" class="s_widget_options_holder tb_cp">
    ...
    <form>
      <div class="tb_subpanel">
        ...
        {{#has_menu_icon}}
        <div class="s_row_1 tbMenuIconWrap">
          <div class="s_row_1">
            <label>Icon</label>
            <div class="s_select">
          ...
          <div class="s_row_1 tbImageIconRow">
            <label>&nbsp;</label>
            <div class="s_full clearfix">
              <input type="hidden" name="menu_icon_image" value="" id="menu_icon_image_input" />
              <span class="tb_thumb">
                <img src="<?php echo $no_image; ?>" id="menu_icon_image_preview" class="image" onclick="image_upload('menu_icon_image_input', 'menu_icon_image_preview');" style="height: 80px;" />
              </span>
              <a class="s_button s_white s_h_30 s_ml_15 s_icon_10 s_delete_10" href="javascript:;" onclick="$('#menu_icon_image_preview').attr('src', '<?php echo $no_image; ?>');$('#menu_icon_image_input').val('');">Remove</a>
            </div>
          </div>
          <div class="s_row_1 tbIconRow">
            ...
            <div class="s_full clearfix">
              ...
              <input class="s_spinner s_ml_10" type="text" min="10" step="5" name="menu_icon_size" data-default="100" size="6" />
              <span class="s_metric">%</span>
              <span class="clear s_mt_20"></span>
              <div class="inline-block valign_top tbColorOption">
                <div class="colorSelector"><div></div></div>
