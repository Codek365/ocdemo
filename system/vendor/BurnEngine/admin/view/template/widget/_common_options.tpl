    ...
    <fieldset class="tbMarginFieldset">
      ...
      <div class="tb_wrap">
        <div class="s_row_2 tb_col tb_1_5">
          <label>Top</label>
          <input class="s_spinner" type="text" min="-120" max="100" step="5" name="<?php echo $input_property; ?>[layout][margin_top]" value="<?php echo $options['layout']['margin_top']; ?>" size="6" />
          <span class="s_metric">px</span>
        </div>
        <div class="s_row_2 tb_col tb_1_5">
          <label>Bottom</label>
          <input class="s_spinner" type="text" min="-120" max="100" step="5" name="<?php echo $input_property; ?>[layout][margin_bottom]" value="<?php echo $options['layout']['margin_bottom']; ?>" size="6" />
          <span class="s_metric">px</span>
        </div>
        <div class="s_row_2 tb_col tb_1_5">
          <label>Left</label>
          <input class="s_spinner" type="text" min="-120" max="100" step="5" name="<?php echo $input_property; ?>[layout][margin_left]" value="<?php echo $options['layout']['margin_left']; ?>" size="6" />
          <span class="s_metric">px</span>
        </div>
        <div class="s_row_2 tb_col tb_1_5">
          <label>Right</label>
          <input class="s_spinner" type="text" min="-120" max="100" step="5" name="<?php echo $input_property; ?>[layout][margin_right]" value="<?php echo $options['layout']['margin_right']; ?>" size="6" />
          <span class="s_metric">px</span>
        </div>
