        ...
        <fieldset>
          ...
          <div class="tb_wrap tb_gut_30">
            <div class="s_row_2 tb_col tb_1_4">
              ...
              <label class="tb_toggle"><input type="checkbox" name="widget_data[responsive_stack]" value="1"<?php if($settings['responsive_stack'] == '1') echo ' checked="checked"';?> /><span></span><span></span></label>
            </div>
            <div class="s_row_2 tb_col tb_1_4">
