    ...
    <div class="tb_tabs tb_subpanel_tabs tb_side_panel_tabs">
      ...
      <div id="layout_builder_widgets_custom" class="tb_subpanel">
        <div class="s_builder_row_widgets_listing clearfix">
          ...
          <div class="tbWidgetsList">
            ...
            <div class="s_widget<?php if ($widget->getClassName() == 'Theme_GroupWidget'): ?> tbGroupWidget<?php endif; ?> tbWidget" id_prefix="<?php echo $widget->getClassName(); ?>"<?php if (!$widget->hasArea($area_name)): ?> style="display: none;"<?php endif; ?>>
      ...
      <div id="layout_builder_widgets_favourites" class="tb_subpanel">
        <div class="s_builder_row_widgets_listing clearfix">
          ...
          <?php if ($widget->getClassName() != 'Theme_OpenCartWidget'): ?>
            <div id="<?php echo $widget->getId(); ?>" class="s_widget<?php if ($widget->getClassName() == 'Theme_GroupWidget'): ?> tbGroupWidget<?php endif; ?> tbWidget" id_prefix="<?php echo $widget->getClassName(); ?>"<?php if (!$widget->hasArea($area_name)): ?> style="display: none;"<?php endif; ?>>
              <h3><?php echo $widget->getName(); ?></h3>
              <div class="s_widget_actions">
                <div class="s_buttons_group">
                  <?php if ($widget->getClassName() == 'Theme_GroupWidget'): ?>
