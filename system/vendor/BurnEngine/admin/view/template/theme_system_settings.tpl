...
<div class="tb_tabs tb_subpanel_tabs">
      ...
      <div id="system_settings_performance_general">
        ...
        <div class="s_row_1 tb_wrap">
          ...
          <div class="s_row_1 tb_col tb_1_2">
            ...
            <input class="s_spinner" type="text" name="system[bg_lazyload_expand]" value="<?php echo $system['bg_lazyload_expand']; ?>" size="7" min="10" max="1000" step="10" />
  ...
  <div id="system_settings_info" class="tb_subpanel">
    ...
    <div class="tb_wrap s_mb_10">
      ...
      <div class="tb_col tb_4_5"><?php echo $tbData->theme_info['name']; ?> v<?php echo $tbData->theme_info['version']; ?> <small class="s_small">/installed on <?php echo $theme_settings['install_info']['install_date']; ?>/</small></div>
    </div>

    <div class="tb_wrap s_mb_10">
      <div class="tb_col tb_1_5"><strong>BurnEngine version</strong></div>
      <div class="tb_col tb_4_5"><?php echo $tbData->engine_version; ?> <small class="s_small">/installed on <?php echo $tbData->engine_log_install['date']; ?>/</small></div>
    </div>
