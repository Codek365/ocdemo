        ...
        $menuItem.find(".tbEditMenuItem").bind("click", function() {
            ...
            if (options.has_menu_icon) {
                ...
                $('.tbMenuColorInherit, .tbMenuIconColorInherit').each(function() {
                    var $color_row     = $(this).closest('.s_row_1').find('.tbColorOption'),
                        $color_preview = $(this).closest('.s_row_1').find('.tbColorOption .colorSelector'),
                        $color_input   = $(this).closest('.s_row_1').find('.tbColorOption input');
                    ...
                    $(this).bind('change', function() {
                        ...
                        $('.tbMenuIconColorAsHover').closest('div').toggle(!$(this).is(":checked"));
                    }).trigger('change');
                });
