...
class Theme_Admin_ModuleController extends Controller
{
    ...
    public function onControllerBefore()
    {
        ...
        $this->getEngine()->getOcEvent()->register('view/*/before', new Action('theme/BurnEngine/onViewBefore'));
        $this->getEngine()->getOcEvent()->register('model/*/after', new Action('theme/BurnEngine/onModelAfter'));
    ...
    {
        return version_compare(VERSION, '2.2.0.0', '>=') ? 'theme' : 'module';
    }
