            ...
            <div class="tb_row_1">
              ...
              <div class="left">
                ...
                <?php if ($language_keywords): ?>
                    ...
                    <br />
                    <input type="text" name="story[language_keyword][<?php echo $language['id']; ?>]" value="<?php echo $language['keyword']; ?>" size="45" /> <img src="view/image/flags/<?php echo $language['image']; ?>" title="<?php echo $language['name']; ?>" />
                    <?php endforeach; ?>
                <?php endif; ?>
              </div>
            </div>
