...
class ModelStoriesSystem extends ModelStoriesModel
{
    public function install($redirect = true)
    {
        ...
        $userGroupModel->addPermission($this->user->getId(), 'access', 'stories/index');
        $userGroupModel->addPermission($this->user->getId(), 'access', 'stories/tag');
        $userGroupModel->addPermission($this->user->getId(), 'access', 'stories/module');

        $userGroupModel->addPermission($this->user->getId(), 'modify', 'stories/index');
        $userGroupModel->addPermission($this->user->getId(), 'modify', 'stories/tag');
        $userGroupModel->addPermission($this->user->getId(), 'modify', 'stories/module');
