<div<?php if (count($languages) > 1) echo ' class="tb_tabs tb_fly_tabs tbLanguageTabs"'; ?>>
  ...
  <div id="store_settings_menu_warning" class="s_server_msg s_msg_yellow">
    <p class="s_icon_32 s_error_32 align_left"><span class="tb_alert_text">The navigation generated by Menu Composer will not be available until you <br /> disable <strong>Theme Settings > System > Compatibility > Default menu code</strong> option.</span></p>
  </div>
