...
class Theme_Catalog_ProductsModel extends TB_ExtensionModel
{
    ...
    public function getLimits($url)
    {
        ...
        $limits[] = array(
            'text'  => $this->getOcConfig()->get($this->manager->gteOc2() ? 'config_product_limit' : 'config_catalog_limit'),
            'value' => $this->getOcConfig()->get($this->manager->gteOc2() ? 'config_product_limit' : 'config_catalog_limit'),
