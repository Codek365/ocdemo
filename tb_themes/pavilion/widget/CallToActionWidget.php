        ...
        return array(
            'additional' => array(
                ...
                'button' => array(
                    ...
                    'can_inherit' => 1,
                    'inherit'     => 1,
                    'inherit_key' => 'row:forms.button'
                ),
                'button_text' => array(
                    'label'       => 'Button Text',
                    'elements'    => 'a.tb_button.tb_button.tb_button',
                    'property'    => 'color',
                    'color'       => '#ffffff',
                    'important'   => 1,
                    'force_print' => 0,
                    'can_inherit' => 1,
                    'inherit'     => 1,
                    'inherit_key' => 'row:forms.button_text'
                ),
                'button_hover' => array(
                    'label'       => 'Button (hover)',
                    'elements'    => 'a.tb_button.tb_button:hover',
                    'property'    => 'background-color',
                    'color'       => '#333333',
                    'important'   => 1,
                    'force_print' => 1,
                    'can_inherit' => 1,
                    'inherit'     => 1,
                    'inherit_key' => 'row:forms.button_hover'
                ),
                'button_text_hover' => array(
                    'label'       => 'Button Text (hover)',
                    'elements'    => 'a.tb_button.tb_button.tb_button:hover',
                    'property'    => 'color',
                    'color'       => '#ffffff',
                    'important'   => 1,
                    'force_print' => 1,
                    'can_inherit' => 1,
                    'inherit'     => 1,
                    'inherit_key' => 'row:forms.button_text_hover'
                )
            )
        );
    }
