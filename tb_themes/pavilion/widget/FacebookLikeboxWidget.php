    ...
    {   
        if ($this->settings['like_box_style'] == 'custom') {
            ...
            if ($get_remote_content) {
                $url = 'https://www.facebook.com/v2.3/plugins/page.php?href=' . $this->settings['lang'][$this->language_id]['page_url'] . '&locale=es_ES&width=1100&height=400';
                ...
                $text_people_like = sprintf($this->manager->getThemeExtension()->translate('text_people_like'), $num_likes, $this->settings['lang'][$this->language_id]['page_url'], $page_title);
