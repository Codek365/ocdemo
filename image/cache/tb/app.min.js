...
Array.prototype.forEach.call(callbacks,function(callBack){callBack();});}};tbApp.on("tbWindowLoaded",function(){tbApp.windowLoaded=true;});tbApp.on("tbScriptLoaded",function(){tbApp.scriptloaded=true;if(tbApp.executeInline!==undefined){tbApp.executeInline.call(window,tbApp);}});if(config!==undefined){for(var k in config){tbApp[k]=config[k];}}})(window);