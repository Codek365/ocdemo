    ...
    <div class="cart-info mini-cart-info tb_table_1">
      <table>
        ...
        <tr>
          ...
          <td class="remove"><button class="tb_button_remove tb_button tb_bg_str_3 tb_text_str_6 tb_h_24 tb_fixed" type="button" onclick="cart.remove('<?php echo $product['cart_id']; ?>');" title="<?php echo $button_remove; ?>"></button></td>
          <?php else: ?>
