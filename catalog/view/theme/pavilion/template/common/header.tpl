...
<div id="fb-root"></div>
<script type="text/javascript">window.fbAsyncInit = function() { FB.init({<?php if($tbData->facebook['app_id']): ?>appId: '<?php echo $tbData->facebook['app_id']; ?>',<?php endif; ?> status: true, xfbml: true, version: 'v2.3' }); }; (function(d, s, id) { var js, fjs = d.getElementsByTagName(s)[0]; if (d.getElementById(id)) {return;} js = d.createElement(s); js.id = id; js.async=true; js.src = "//connect.facebook.net/<?php if($tbData->facebook['locale']) { echo $tbData->facebook['locale']; } else { echo 'en_US'; } ?>/sdk.js"; fjs.parentNode.insertBefore(js, fjs); }(document, 'script', 'facebook-jssdk'));</script>
<?php endif; ?>
