...
.tb_table           { display: table !important; width: 100%; table-layout: fixed; }
...
.form-group.tb_style_2 .checkbox.image > label img,
...
.tb_list_view .tb_product .tb_button_add_to_cart:last-child .tb_button {
  top: auto;
}
...
.tb_listing.tb_inline_view.tb_min_w_900 {
  ...
  <?php else: ?>
  padding-right: <?php echo $base * 1.5 * 2; ?>px;
  <?php endif; ?>
}
...
.tb_listing.tb_inline_view.tb_min_w_900 .tb_item.clear3 {
  ...
  <?php else: ?>
  clear: right;
  margin-right: -<?php echo $base * 1.5 * 2; ?>px;
  <?php endif; ?>
}
...
#main_navigation .tb_nav .tb_megamenu > .tb_submenu > .tb_row > .tb_wrap > [class*="tb_col_"] > ul > li > .tb_submenu > .tb_list_1 {
  margin-left: 0 !important;
  margin-right: 0 !important;
}
...
.form-group.tb_style_2 .checkbox > label div,
.form-group.tb_style_2 .radio > label div
{
  display: none;
}
...
@media only screen and (min-width: 768px) {
  .tb_products.tb_grid_view .tb_item,
  .tb_products.tb_grid_view .tb_item .tb_item_info
  {
    display: -moz-box;
    display: -ms-flexbox;
    display: -webkit-flex;
  ...
  .tb_products.tb_grid_view .tb_item .tb_thumb {
  ...
  .tb_products.tb_grid_view .tb_item .tb_item_info,
  .tb_products.tb_grid_view .tb_item .tb_item_info_active
  {
    -webkit-box-flex: 1;
       -moz-box-flex: 1;
        -webkit-flex: 1;
  ...
  .tb_products.tb_grid_view .tb_item .tb_item_info_hover,
  .tb_products.tb_grid_view .tb_item .tb_item_info .tb_description,
  .tb_products.tb_grid_view .tb_item .tb_item_info .tb_price_holder
  {
...
@media only screen and (max-width: 767px) {
  ...
  #main_navigation .tb_nav > ul > li > a > .tb_accent_label
  {
    left: auto;
    right: auto;
  }
