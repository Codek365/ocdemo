<div class="tb_products tb_listing <?php echo $listing_classes; ?> clearfix">
  ...
  <div class="tb_product tb_item <?php echo $product['tb_classes']; ?>">
    ...
    <div class="tb_item_info">
      ...
      <?php endif; ?>
      <?php if ($product['show_stock'] && $product['quantity'] < 1 && !$config_stock_checkout): ?>
...
tbApp.init<?php echo $widget->getDomId(); ?> = function() {
    tbApp.onScriptLoaded(function() {
        ...
        <?php // PRODUCT SLIDER ?>
        <?php if ($slider): ?>
        tbApp.itemSlider<?php echo $widget->getDomId(); ?> = createItemSlider('#<?php echo $widget->getDomId(); ?>', <?php echo count($products); ?>, <?php echo $slider_step; ?>, <?php echo $slider_speed; ?>, <?php $slider_pagination ? print '\'#' . $widget->getDomId() . ' .tb_slider_pagination\'' : print 'false' ; ?>, <?php echo $restrictions_json; ?>, <?php echo $slider_autoplay; ?>)
        <?php endif; ?>
    });
}
