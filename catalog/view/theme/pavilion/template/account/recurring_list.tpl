...
<div class="tb_recurring_payments tb_table_1">
  <table>
    <thead>
      <tr>
        <th class="id" width="130"><?php echo $column_order_recurring_id; ?></th>
        ...
        <th class="action" width="130"></th>
      </tr>
    </thead>
    <tbody>
      <?php foreach ($recurrings as $recurring) { ?>
      <tr>
        <td class="id">#<?php echo $recurring['order_recurring_id']; ?></td>
        <td class="name"><?php echo $recurring['product']; ?></td>
        <td class="status"><?php echo $recurring['status']; ?></td>
        <td class="date"><?php echo $recurring['date_added']; ?></td>
        <td class="action"><a class="tb_button tb_fixed" href="<?php echo $recurring['view']; ?>" title="<?php echo $button_view; ?>"><i class="fa fa-search"></i></a></td>
      </tr>
      <?php } ?>
    </tbody>
  </table>
