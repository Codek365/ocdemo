...
<div class="tb_wrap tb_sep">
  <div class="tb_col_1_2">
    <dl class="tb_dlist_1">
      <dt><?php echo $text_order_recurring_id; ?></dt><dd>#<?php echo $order_recurring_id; ?></dd>
      <dt><?php echo $text_date_added; ?></dt><dd><?php echo $date_added; ?></dd>
      <dt><?php echo $text_status; ?></dt><dd><?php echo $status; ?></dd>
      <dt><?php echo $text_payment_method; ?></dt><dd><?php echo $payment_method; ?></dd>
    </dl>
  </div>
  <div class="tb_col_1_2">
    <dl class="tb_dlist_1">
      <dt><?php echo $text_order_id; ?></dt><dd><a class="tb_main_color" href="<?php echo $order; ?>">#<?php echo $order_id; ?></a></dd>
      <dt><?php echo $text_product; ?></dt><dd><a href="<?php echo $product; ?>"><?php echo $product_name; ?></a></dd>
      <dt><?php echo $text_quantity; ?></dt><dd><?php echo $product_quantity; ?></dd>
    </dl>
  </div>
</div>
<?php else: ?>
