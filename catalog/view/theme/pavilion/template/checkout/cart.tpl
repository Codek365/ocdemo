          ...
          <tr>
            ...
            <td class="quantity">
              <div class="tb_button_group">
                ...
                <input type="number" name="quantity[<?php echo $product['cart_id']; ?>]" value="<?php echo $product['quantity']; ?>" />
                <?php else: ?>
                ...
                <?php if ($tbData->OcVersionGte('2.1.0.0')): ?>
                <button class="tb_button_danger tb_fixed" type="button" title="<?php echo $button_remove; ?>" onclick="cart.remove('<?php echo $product['cart_id']; ?>');"><i class="fa fa-times"></i></button>
                <?php else: ?>
                <button class="tb_button_danger tb_fixed" type="button" title="<?php echo $button_remove; ?>" onclick="cart.remove('<?php echo $product['key']; ?>');"><i class="fa fa-times"></i></button>
                <?php endif; ?>
              </div>
            </td>
