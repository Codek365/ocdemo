...
<style scoped>
<?php if ($images): ?>
<?php if ($gallery['nav_position'] == 'bottom'): ?>
...
tbApp.onScriptLoaded(function() {
    ...
    $slider.one('coverLoaded', function (eventName) {
      $('#product_images .tb_thumbs ul').removeClass('tb_grid_view');
    });
...
<?php if ($tbData['system.product_price']['show_savings']): ?>
    ...
    $('#content').find('select[name="profile_id"], :input[name^="option"], :input[name^="quantity"]').change(function(){
        $.ajax({
            ...
            success: function (data) {
                ...
                var $priceWrap = $('.tb_widget_product_price_system');
...
<div class="row">
  ...
  <div class="tb_purchase_button col-xs-auto col-valign-middle">
  ...
  <?php endif; ?>
  <div class="tb_actions col-xs-fill col-valign-middle">
...
<div class="panel-body tb_share_box">
  <?php if ($tbData['system.product_share']['button_facebook']): ?>
  <div class="tb_facebook lazyload" data-expand="50">
    <a class="fb-like" data-layout="button_count" data-action="like" data-show-faces="true" data-share="false"></a>
    <?php if ($tbData->system['image_lazyload']): ?>
    <script>
    tbApp.onScriptLoaded(function() {
      $('#{{widget_dom_id}} .tb_facebook.lazyload').bind('lazybeforeunveil', function() {
  ...
  <div class="tb_twitter lazyload" data-expand="50">
    ...
    tbApp.onScriptLoaded(function() {
      ...
      <?php if ($tbData->system['image_lazyload']): ?>
      $('#{{widget_dom_id}}').bind('lazybeforeunveil', loadTwitter);
      <?php else: ?>
      loadTwitter();
      <?php endif; ?>
    });
  ...
  <div class="tb_gplus" style="width: 57px;">
    <a class="g-plusone lazyload" data-expand="50" data-size="medium"></a>
    <script>
    tbApp.onScriptLoaded(function() {
      ...
      <?php if ($tbData->system['image_lazyload']): ?>
      $('#{{widget_dom_id}}').bind('lazybeforeunveil', loadGplus);
      <?php else: ?>
      loadGplus();
      <?php endif; ?>
    });
  ...
  <div class="tb_pinterest lazyload" data-expand="50">
    ...
    tbApp.onScriptLoaded(function() {
      ...
      <?php if ($tbData->system['image_lazyload']): ?>
      $('#{{widget_dom_id}}').bind('lazybeforeunveil', loadPinterest);
      <?php else: ?>
      loadPinterest();
      <?php endif; ?>
    });
  ...
  <div class="tb_stumbleupon lazyload" data-expand="50">
    ...
    tbApp.onScriptLoaded(function() {
      ...
      <?php if ($tbData->system['image_lazyload']): ?>
      $('#{{widget_dom_id}}').bind('lazybeforeunveil', loadSU);
      <?php else: ?>
      loadSU();
      <?php endif; ?>
    });
  ...
  <div class="tb_social_button tb_linkedin lazyload" data-expand="50">
...
<?php if ($view_mode == 'grid' && $tbData->optimize_js_load): ?>
