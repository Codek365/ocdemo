...
$main_width          = '100%';
$main_width         .= $tbData->hasArea('column_left')  ?  ' - ' . $left_col_width : '';
$main_width         .= $tbData->hasArea('column_right') ?  ' - ' . $right_col_width : '';
$main_width         .= !$tbData->content_layout_settings['separate_columns'] && $tbData->hasArea('column_left')  && $left_col_metric  == 'px' ? ' - ' . $tbData->content_layout_settings['columns_gutter'] . 'px' : '';
$main_width         .= !$tbData->content_layout_settings['separate_columns'] && $tbData->hasArea('column_right') && $right_col_metric == 'px' ? ' - ' . $tbData->content_layout_settings['columns_gutter'] . 'px' : '';
?>
