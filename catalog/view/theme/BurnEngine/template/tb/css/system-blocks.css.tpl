...
@media (min-width: <?php echo $screen_xs . 'px'; ?>) and (max-width: <?php echo ($screen_sm - 1) . 'px'; ?>) {
  #site_logo img {
...
@media (min-width: <?php echo $screen_sm . 'px'; ?>) and (max-width: <?php echo ($screen_md - 1) . 'px'; ?>) {
  #site_logo img {
...
@media (min-width: <?php echo $screen_md . 'px'; ?>) {
  #site_logo img {
...
.tb_widget_product_add_to_cart_system .tb_purchase_button > .input-group
{
  ...
  display: inline-flex;
  width: calc(3em + <?php echo $form_control_height_lg - $base - $form_border_width; ?>px);
