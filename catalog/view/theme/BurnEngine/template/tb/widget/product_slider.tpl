...
tbApp.onScriptLoaded(function() {
    var callback = function(swiperObj) {
        ...
        var slideCallBack = function(swiper) {
            var $el = $(swiper.activeSlide()).find('.product-thumb').clone();
        ...
        swiperObj.addCallback('Init', slideCallBack);
        swiperObj.addCallback('SlideChangeStart', function() {
            $cont.find('.tb_item_info').removeClass('tbShowInfo');
        });
        swiperObj.addCallback('SlideChangeEnd', slideCallBack);
