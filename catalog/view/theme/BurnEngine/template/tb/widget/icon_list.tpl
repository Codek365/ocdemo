...
<?php if ($description_position == 'tooltip'
          || ($display == 'grid' && (!empty($within_group) || !$tbData->optimize_js_load))
): ?>
...
<?php endif; ?>
<?php if ($display == 'grid' && (!empty($within_group) || !$tbData->optimize_js_load)): ?>
...
<?php endif; ?>
<?php if ($tbData->optimize_js_load && $display == 'grid'): ?>
