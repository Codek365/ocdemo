...
#<?php echo $widget->getDomId(); ?> ul.uiList {
  ...
  <?php else: ?>
  height: <?php echo ($tbData->fonts['body']['line-height'] + 50 + $border_offset) * $profiles_rows; ?>px;
  <?php endif; ?>
}
</style>
<?php endif; ?>
...
<?php endif; ?>
<?php if ($like_box_style == 'custom'): ?>
<div class="tb_fb_likebox<?php echo $like_box_classes; ?> tb_social_box tb_custom lazyload" data-expand="-100">
...
<?php else: ?>
<div class="tb_fb_likebox tb_social_box tb_default<?php if ($default_small_header): ?> tb_small_header<?php endif; ?> lazyload">
...
tbApp.onScriptLoaded(function() {
  $('#<?php echo $widget->getDomId(); ?>').bind('lazybeforeunveil', function() {
